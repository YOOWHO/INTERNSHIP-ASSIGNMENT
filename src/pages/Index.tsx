        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              {/* Notification Bell */}
              <button className="w-9 h-9 flex items-center justify-center rounded-full hover:bg-gray-200 transition-colors" onClick={() => console.log('Clicked Notification Bell')}>
      ...
      <div className="max-w-full">
        ...
        <div className="bg-white border-t border-gray-200 px-2 py-0">
          <div className="flex items-center gap-1 mt-1">
            <button className="px-4 py-2 text-sm font-semibold text-green-700 bg-white border-b-2 border-green-500 focus:outline-none" onClick={() => console.log('Clicked All Orders Tab')}>
              All Orders
            </button>
            <button className="px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 border-b-2 border-transparent focus:outline-none" onClick={() => console.log('Clicked Pending Tab')}>
              Pending
            </button>
            <button className="px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 border-b-2 border-transparent focus:outline-none" onClick={() => console.log('Clicked Reviewed Tab')}>
              Reviewed
            </button>
            <button className="px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 border-b-2 border-transparent focus:outline-none" onClick={() => console.log('Clicked Arrived Tab')}>
              Arrived
            </button>
            <button className="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-gray-600 rounded border-none bg-transparent text-xl" onClick={() => console.log('Clicked Plus Tab')}>
              +
            </button>
          </div>
        </div>
